...
public class URLUtils {
    ...
    public static final String HTTP_WWW_HEAD = "www.";
    ...
    public static final String getRealDomain(String url) {
        String domain = getDomain(url);
        if (domain == null) {
            return null;
        }
        if (domain.startsWith(HTTP_WWW_HEAD)) {
            domain = domain.replaceFirst(HTTP_WWW_HEAD, "");
        }
        return domain;
    }
    ...
    ".ac", ".ad", ".ae", ".af", ".ag", ".ai", ".al", ".am", ".an", ".ao", ".aq", ".ar", ".as", ".at", ".au", ".aw",
            ...
            ".ec", ".eu", ".fi", ".fj", ".fk", ".fm", ".fo", ".fr", ".fx", ".ga", ".gb", ".gd", ".ge", ".gf", ".gh",
            ".gi", ".gl", ".gp", ".gq", ".gf", ".gm", ".gn", ".gr", ".gs", ".gt", ".gu", ".gw", ".gy", ".hk", ".hm",
            ".hn", ".hr", ".ht", ".hu", ".id", ".ie", ".il", ".in", ".io", ".iq", ".ir", ".is", ".it", ".jm", ".jo",
            ".jp", ".ke", ".kg", ".kh", ".ki", ".km", ".kn", ".kp", ".kr", ".kw", ".ky", ".kz", ".la", ".lb", ".lc",
            ".li", ".lk", ".lr", ".ls", ".lt", ".lu", ".lv", ".ly", ".ma", ".mc", ".md", ".mg", ".mh", ".mk", ".ml",
            ".mm", ".mn", ".mo", ".mp", ".mq", ".mr", ".ms", ".mt", ".mu", ".mv", ".mw", ".mx", ".my", ".mz", ".na",
            ".nc", ".ne", ".nf", ".ng", ".ni", ".nl", ".no", ".np", ".nr", ".nt", ".nu", ".nz", ".om", ".pa", ".pe",
            ".pf", ".pg", ".ph", ".pk", ".pl", ".pm", ".pn", ".pt", ".pr", ".pw", ".py", ".qa", ".re", ".ro", ".ru",
            ".rw", ".sa", ".sb", ".sc", ".sd", ".se", ".sg", ".sh", ".si", ".sj", ".sk", ".sl", ".sm", ".sn", ".so",
            ".sr", ".st", ".su", ".sv", ".sy", ".sz", ".tc", ".td", ".tf", ".tg", ".th", ".tj", ".tk", ".tm", ".tn",
            ".to", ".tp", ".tr", ".tt", ".tv", ".tw", ".tz", ".ua", ".ug", ".uk", ".um", ".us", ".uy", ".uz", ".va",
            ...
            ".co", ".cq", ".cr", ".cu", ".cv", ".cx", ".cy", ".cz", ".de", ".dj", ".dk", ".dm", ".do", ".dz", ".ec",
            ".ee", ".eg", ".eh", ".es", ".et", ".ev", ".fi", ".fj", ".fk", ".fm", ".fo", ".fr", ".ga", ".gb", ".gd",
            ".ge", ".gf", ".gh", ".gi", ".gl", ".gm", ".gn", ".gp", ".gr", ".gt", ".gu", ".gw", ".gy", ".hk", ".hm",
            ".hn", ".hr", ".ht", ".hu", ".id", ".ie", ".il", ".in", ".io", ".iq", ".ir", ".is", ".it", ".jm", ".jo",
            ".jp", ".ke", ".kg", ".kh", ".ki", ".km", ".kn", ".kp", ".kr", ".kw", ".ky", ".kz", ".la", ".lb", ".lc",
            ".li", ".lk", ".lr", ".ls", ".lt", ".lu", ".lv", ".ly", ".ma", ".mc", ".md", ".me", ".mg", ".mh", ".ml",
            ".mm", ".mn", ".mo", ".mp", ".mq", ".mr", ".ms", ".mt", ".mv", ".mw", ".mx", ".my", ".mz", ".na", ".nc",
            ".ne", ".nf", ".ng", ".ni", ".nl", ".no", ".np", ".nr", ".nt", ".nu", ".nz", ".om", ".pa", ".pe", ".pf",
            ".pg", ".ph", ".pk", ".pl", ".pm", ".pn", ".pr", ".pt", ".pw", ".py", ".qa", ".re", ".ro", ".rs", ".ru",
            ".rw", ".sa", ".sb", ".sc", ".sd", ".se", ".sg", ".sh", ".si", ".sj", ".sk", ".sl", ".sm", ".sn", ".so",
            ".sr", ".st", ".su", ".sy", ".sz", ".tc", ".td", ".tf", ".tg", ".th", ".tj", ".tk", ".tl", ".tm", ".tn",
            ".to", ".tp", ".tr", ".tt", ".tv", ".tw", ".tz", ".ua", ".ug", ".uk", ".us", ".uy", ".va", ".vc", ".ve",
    ...
    // 所有顶级域名列表(不带前边的.)
    public static HashMap urlPostfixMap_noDot = new HashMap();
    // 最初定义的几组业务相关的顶级域名列表(不带前边的.)
    public static HashMap regionalUrlPostfixMap_noDot = new HashMap();
    // 后来加入的国家级顶级域名列表(不带前边的.)
    public static HashMap traditionalUrlPostfixMap_noDot = new HashMap();
    ...
    static {
        ...
        for (int i = 0; i < fixupPostfix.length && i + 1 < fixupPostfix.length; i += 2) {
            ...
            {
                HashMap obj = (HashMap) urlPostfixMap.get(key);
                if (obj == null) {
                    obj = new HashMap();
            ...
            if (key.length() > 0 && val.length() > 0) {
                key = key.substring(1);
                val = val.substring(1);
                HashMap obj = (HashMap) urlPostfixMap_noDot.get(key);
                if (obj == null) {
                    obj = new HashMap();
    ...
    public static final String validateDomain(String domain) {
        ...
        do {
            ...
            } catch (NoSuchElementException e) {} catch (NumberFormatException e) {}
    ...
    // if( buff == null || b == null || idx < 0 || idx + b.length > buff.length
    // ) return false;
     ...
     */
    /*
     * public static final String[] probeAllCharsets(byte[] s) { if( s == null
     * || s.length == 0 ) return null; return probeAllCharsets(s,s.length); }
     * public static final String[] probeAllCharsets(byte[] s, int limit) { if(
     * s == null || limit <=0 || limit > s.length ) return null; nsDetector det
     * = new nsDetector(nsDetector.SIMPLIFIED_CHINESE);
     * nsICharsetDetectionObserver c = null; det.Init(c); int limitPerIteration
     * = 1024; if (limit <= limitPerIteration) { det.DoIt(s, limit, false);
     * det.Done();
     * 
     * String prob[] = det.getProbableCharsets(); String cs = prob.length > 0 ?
     * prob[0] : "not found"; return prob; // return cs; } byte[] bytes = new
     * byte[limitPerIteration]; int index = 0; while ((index +
     * limitPerIteration) < limit) { System.arraycopy(s, index, bytes, 0,
     * limitPerIteration); if (det.DoIt(bytes, bytes.length, false)) {
     * det.Done(); String prob[] = det.getProbableCharsets(); String cs =
     * prob.length > 0 ? prob[0] : "not found";
     * 
     * return prob; // return cs; } index += limitPerIteration; }
     * System.arraycopy(s, index, bytes, 0, limit - index); det.DoIt(bytes,
     * bytes.length, false); det.Done(); String prob[] =
     * det.getProbableCharsets(); String cs = prob.length > 0 ? prob[0] :
     * "not found";
     * 
     * return prob; // return cs;
     * 
     * }、 /** 判断字符串可能的编码类型
     * 
     ...
     */
    /*
     * public static final String probeCharset(String line){ String dft = null;
     * String ret = null; int limit = Integer.MAX_VALUE>>2; if( line == null ||
     * line.length() == 0 || line.length() >= limit ) return dft; byte[] buff =
     * new byte[line.length()*2]; int n = genericUrlDecode(line, buff); if( n >=
     * 0 ){ ret = probeCharset(buff, 0, n); } else if( n == -1 ){ // 参数有问题 ret =
     * dft; } else if( n == -2 ){ // 空间不足，重试 buff = new byte[line.length()*4]; n
     * = genericUrlDecode(line, buff); if( n < 0 ){ ret = dft; } else { ret =
     * probeCharset(buff, 0, n); } } else if( n == -4 ){ // n == -4 编码类型确认为GBK
     * ret = "GBK"; } else {// n == -3 未知错误 ret = dft; } return ret;
     * 
     * }
     * 
     * private static final float count(String str){ if( str == null ||
     * str.length() == 0 ) return 1.0f; int total = 0; float sum = 0.0f; for(int
     * i=0;i<str.length(); i++){ char ch = str.charAt(i); if( ch > 128 ){ total
     * ++; if( !GB2312Charset.has(ch) ){ sum += 1.0f; } else { if( ch < 39 * 8 *
     * 64 ){ sum += 0.05; } else if( ch < 58 * 8 * 64 ){ sum += 0.07; } else if(
     * ch > 80 * 8 * 64 ){ sum += 0.2; } } } } return total == 0 ? 1 :
     * (sum)/total; } /** 判定一段码流对应的编码类型
     * 
     ...
     * return null; } byte[] buff = new byte[limit]; System.arraycopy(bb, start,
     * buff, 0, limit); String[] css = probeAllCharsets(buff); for (String cs :
     * css) { if ( cs.equals("GBK") || cs.equals("GB2312") ||
     * cs.equals("GB18030")) return "GBK"; else if( cs.equals("UTF-8") ){ //
     * fixup // 发现chardet包对“一”等字的识别有明显的问题 { try{ String str = new String( bb,
     * start, limit, cs); if(count(str) > 0.5){ cs = "GBK"; } }catch(Exception
     * e){ cs = "GBK"; } } return cs; } } return null;
     * 
     * }
     * 
    ...
    public static final String getParameter(String url, String param) {
        ...
        while (true) {
            ...
            if (idx < 0) {
                ...
                left = idx;
                break;
            } else if (url.charAt(idx - 1) == '?' || url.charAt(idx - 1) == '&') {
                left = idx;
                break;
            } else {
                left = idx;
    ...
    public static void main(String[] args) {
        System.out.println(getDomain("http://www.中国.网络.中国"));
        System.out.println(getRealDomain("http://www.中国.网络.中国"));
        System.out.println(getMainDomain("http://www.中国.电视.网络.中国"));
        System.out.println(getLookupUrl("http://www.中国.电视.网络"));
    }
