 ...
 *  @generated
 */
package com.sogou.bizwork.task.api.user.result;
...
public class UserResult implements org.apache.thrift.TBase<UserResult, UserResult._Fields>, java.io.Serializable, Cloneable, Comparable<UserResult> {
  ...
  private static final org.apache.thrift.protocol.TField USER_TO_LIST_FIELD_DESC = new org.apache.thrift.protocol.TField("userToList", org.apache.thrift.protocol.TType.LIST, (short)3);
  ...
  public List<com.sogou.bizwork.task.api.user.to.UserTo> userToList; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    USER_TO_LIST((short)3, "userToList"),
  ...
  private _Fields optionals[] = {_Fields.ERROR_CODE,_Fields.USER_TO_LIST};
  ...
  static {
    ...
    tmpMap.put(_Fields.USER_TO_LIST, new org.apache.thrift.meta_data.FieldMetaData("userToList", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.sogou.bizwork.task.api.user.to.UserTo.class))));
  ...
  public UserResult(UserResult other) {
    ...
    if (other.isSetUserToList()) {
      List<com.sogou.bizwork.task.api.user.to.UserTo> __this__userToList = new ArrayList<com.sogou.bizwork.task.api.user.to.UserTo>(other.userToList.size());
      for (com.sogou.bizwork.task.api.user.to.UserTo other_element : other.userToList) {
        __this__userToList.add(new com.sogou.bizwork.task.api.user.to.UserTo(other_element));
      }
      this.userToList = __this__userToList;
    }
  ...
  public UserResult setStatus(boolean status) {
    this.status = status;
    setStatusIsSet(true);
    return this;
  }
  ...
  public UserResult setErrorCode(com.sogou.bizwork.task.api.common.error.ErrorCode errorCode) {
  ...
  public int getUserToListSize() {
    return (this.userToList == null) ? 0 : this.userToList.size();
  }

  public java.util.Iterator<com.sogou.bizwork.task.api.user.to.UserTo> getUserToListIterator() {
    return (this.userToList == null) ? null : this.userToList.iterator();
  }

  public void addToUserToList(com.sogou.bizwork.task.api.user.to.UserTo elem) {
    if (this.userToList == null) {
      this.userToList = new ArrayList<com.sogou.bizwork.task.api.user.to.UserTo>();
    }
    this.userToList.add(elem);
  }

  public List<com.sogou.bizwork.task.api.user.to.UserTo> getUserToList() {
    return this.userToList;
  }

  public UserResult setUserToList(List<com.sogou.bizwork.task.api.user.to.UserTo> userToList) {
    this.userToList = userToList;
    return this;
  }

  public void unsetUserToList() {
    this.userToList = null;
  }

  /** Returns true if field userToList is set (has been assigned a value) and false otherwise */
  public boolean isSetUserToList() {
    return this.userToList != null;
  }

  public void setUserToListIsSet(boolean value) {
    if (!value) {
      this.userToList = null;
    }
  }
  ...
  public UserResult setTotalNumber(int totalNumber) {
    this.totalNumber = totalNumber;
    setTotalNumberIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case USER_TO_LIST:
      if (value == null) {
        ...
        setUserToList((List<com.sogou.bizwork.task.api.user.to.UserTo>)value);
      }
      break;
  ...
  public boolean equals(UserResult that) {
    ...
    boolean this_present_userToList = true && this.isSetUserToList();
    boolean that_present_userToList = true && that.isSetUserToList();
    if (this_present_userToList || that_present_userToList) {
      if (!(this_present_userToList && that_present_userToList))
        return false;
      if (!this.userToList.equals(that.userToList))
        return false;
    }
  ...
  public int compareTo(UserResult other) {
    ...
    lastComparison = Boolean.valueOf(isSetUserToList()).compareTo(other.isSetUserToList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUserToList()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.userToList, other.userToList);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetUserToList()) {
      if (!first) sb.append(", ");
      sb.append("userToList:");
      if (this.userToList == null) {
        sb.append("null");
      } else {
        sb.append(this.userToList);
      }
      first = false;
    }
    if (!first) sb.append(", ");
  ...
  private static class UserResultStandardScheme extends StandardScheme<UserResult> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.userToList = new ArrayList<com.sogou.bizwork.task.api.user.to.UserTo>(_list0.size);
                for (int _i1 = 0; _i1 < _list0.size; ++_i1)
                {
                  com.sogou.bizwork.task.api.user.to.UserTo _elem2;
                  _elem2 = new com.sogou.bizwork.task.api.user.to.UserTo();
                  _elem2.read(iprot);
                  struct.userToList.add(_elem2);
                }
                iprot.readListEnd();
              }
              struct.setUserToListIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UserResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.userToList != null) {
        if (struct.isSetUserToList()) {
          oprot.writeFieldBegin(USER_TO_LIST_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.userToList.size()));
            for (com.sogou.bizwork.task.api.user.to.UserTo _iter3 : struct.userToList)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class UserResultTupleScheme extends TupleScheme<UserResult> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, UserResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetUserToList()) {
        {
          oprot.writeI32(struct.userToList.size());
          for (com.sogou.bizwork.task.api.user.to.UserTo _iter4 : struct.userToList)
          {
            _iter4.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.userToList = new ArrayList<com.sogou.bizwork.task.api.user.to.UserTo>(_list5.size);
          for (int _i6 = 0; _i6 < _list5.size; ++_i6)
          {
            com.sogou.bizwork.task.api.user.to.UserTo _elem7;
            _elem7 = new com.sogou.bizwork.task.api.user.to.UserTo();
            _elem7.read(iprot);
            struct.userToList.add(_elem7);
          }
        }
        struct.setUserToListIsSet(true);
      }
