...
public class TaskConvertor {
    ...
    public static com.sogou.bizwork.task.api.core.task.po.TaskVo convertTaskDto2Vo(TaskDTO taskDto) {
        com.sogou.bizwork.task.api.core.task.po.TaskVo taskVo = new com.sogou.bizwork.task.api.core.task.po.TaskVo();
        if (taskDto == null)
            return taskVo;
        ...
        taskVo.setScore(taskDto.getScore());
        taskVo.setScoreId(taskDto.getScoreId());
        return taskVo;
    }

    public static TaskDTO convertTaskVo2Dto(com.sogou.bizwork.task.api.core.task.po.TaskVo taskVo) {
